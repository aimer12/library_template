...
from tor_manager.service.bookmanage import BookHandler
from tor_manager.service.borrowmanage import BorrowHandler
from tor_manager.service.readermanage import ReaderHandler
MODULE = "manager"
...
class Application(tornado.web.Application):
    def __init__(self):
        ...
        handlers = [
            ...
            (r"/bookmanage", BookHandler),
            (r"/borrowmanage", BorrowHandler),
            (r"/readermanage", ReaderHandler),
